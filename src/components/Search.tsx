        ...
        <div className="bg-white shadow-md px-4 py-5 w-11/12 mx-auto rounded-md relative top-[-15px] items-center sm:flex gap-1.5 sm:h-20 ">
            ...
            <div className="flex gap-1 mt-1.5 sm:w-1/2 sm:mt-0">
                <div className="w-1/2 relative">
                    ...
                    {categoriesDropdown && (
                        <div className="w-77 flex flex-wrap absolute mt-2 bg-white rounded-md shadow-lg py-3 px-1.5 border border-gray-200 sm:w-170 sm:px-3">
                ...
                <div className="w-1/2 relative">
                    ...
                    {filterDropdown && (
                        <div className="absolute mt-2 w-40 bg-white rounded-md shadow-lg py-3 px-1.5  border border-gray-200 sm:w-56 sm:px-3">
