    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1">
                {cart.length > 0 ? (<div className="px-5 pt-9 flex flex-col gap-5 items-center justify-center sm:flex-row sm:items-start lg:w-[70%] lg:mx-auto">
                            ...
                            <div className="flex flex-col justify-between mb-2.5">
                                {cart.length > 0 && cart.map((item) => (
                                    <div key={item.id} className="flex gap-2 justify-between">
                                        <p className="font-semibold text-[#7B7878]">{item.title}</p>
